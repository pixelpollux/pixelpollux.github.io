    ...
    return (    
        <div id="extended-bio" className="">
                ...
                <div className="resume__single-position">
                    ...
                    <div className='resume__job-description'>
                        <ul>
                            ...
                            <li>Foster best practices in development through active participation in code reviews and version control management.</li>
                            <li>Drive significant improvements in site performance and ADA compliance through strategic implementation of React, TypeScript, and SASS technologies.</li>
                ...
                <div className="resume__single-position">
                    ...
                    <div className='resume__job-description'>
                        <ul>
                            ...
                            <li>Meticulously maintained and updated documentation, ensuring smooth knowledge transfer and facilitating efficient onboarding of new team members.</li>
                            <li>Streamlined site maintenance processes, resolving issues swiftly to ensure optimal performance and seamless user experience.</li>
                ...
                <div className="resume__single-position">
                    ...
                    <div className='resume__job-description'>
                        <ul>
                            ...
                            <li>Utilized Microsoft Office Suite and Adobe Creative tools for content creation and design, producing visually appealing digital and print assets.</li>
            ...
            <div className='resume__development'>
                ...
                <div className="resume__developemnt-bootcamps">
                    <h4>Bootcamps</h4>
                    <div className="resume__single-position">
                        <div className='resume__subtitle-section'>
                            <div className='resume__job-title'>Skilled KC</div>
                            <div className='resume__job-dates'>October 2020 - March 2021</div>
                        </div>
                        <div className='resume__subtitle-section'>
                            <div className='resume__job-title'>LaunchCode</div>
                            <div className='resume__job-dates'>September 2019 - April 2020</div>
                        </div>
                    </div>
                </div>
                <div className="resume__developemnt-conferences">
                    <h4>Conferences</h4>
                    <div className="resume__single-position">
                        <div className='resume__subtitle-section'>
                            <div className='resume__job-title'>RenderATL</div>
                            <div className='resume__job-dates'>2022, 2023, 2024</div>
                        </div>
                        <div className='resume__subtitle-section'>
                            <div className='resume__job-title'>Grace Hopper Celebration</div>
                            <div className='resume__job-dates'>2021, 2022</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="resume__single-position">
                    ...
                    <div className='resume__job-description'>
                        <ul>
                            ...
                            <li>Collaborate with artists and theme camp organizers on logistics, space allocation, and guideline adherence.</li>
                            <li>Facilitate communication between participants, artists, and volunteers to foster a collaborative and inclusive environment.</li>
                            <li>Implement safety protocols, coordinate with security and medical teams, and ensure compliance with local regulations.</li>
